    ...
    <div class="tooltips">
        <div class="btn-group dropup">
            <button type="button" class="btn btn-success dropdown-toggle btn-circle btn-lg"
                ...
                <i class="fa fa-rss fa-2x" aria-hidden="true" title="{{trans('gitscrum.activities')}}"></i>
            </button>
            <ul id="dropdown-activities" class="dropdown-menu dropdown-menu-right dropdown-menu-form">
                <li>
                    <div class="report">

                        <h4 class="m-t-md">{{trans('gitscrum.issue-labels')}}</h4>
                        ...
                        <h4 class="m-t-md">{{trans('gitscrum.activities')}}</h4>
